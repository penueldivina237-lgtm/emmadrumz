Drum Web — Server README

This small server stores bookings, creates Stripe Checkout Sessions (with booking metadata), and handles Stripe webhooks to mark bookings paid and send confirmation emails.
